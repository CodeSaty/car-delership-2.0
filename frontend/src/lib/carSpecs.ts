...
const SPECS_DB: Record<string, CarSpecs> = {
    ...
    "ferrari|roma": {
        ...
        features: ["Manettino Drive Modes", "Magnetic Damping SCM-E", "Adaptive LED Headlights", "Ferrari Dynamic Enhancer", "Virtual Short Wheelbase 2.0"],
        safety: ["6 Airbags", "ABS with EBD", "E-Diff3 Electronic Differential", "Stability Control", "ADAS Driver Assistance"],
        interior: ["Dual-Cockpit Design", "Hand-Stitched Leather", "Card-Key Start", "16\" Curved HD Display", "Harman Kardon Premium Audio", "Aluminum Paddle Shifters"],
        description: "The Ferrari Roma is 'la nuova dolce vita' — a beautiful front-engine V8 coupe inspired by 1960s Roman elegance. With 612 hp and a sleek fastback design, it blends breathtaking GT performance with timeless Italian style. The most beautiful Ferrari in a generation.",
        sketchfabId: "cbc0c13c0fb54fc8bbfa79a9ff99e3aa",
    },
    ...
    "bmw|m5": {
        ...
        seatingCapacity: 5,
        doors: 4,
        generation: "G90 (7th Gen)",
        countryOfOrigin: "Germany",
        engine: {
            type: "Twin-Turbocharged V8 + Electric Motor",
            displacement: "4.4L (4,395 cc) + Electric Motor",
            configuration: "V8 90° Hot-Vee + Hybrid",
            horsepower: "717 hp combined",
        ...
        performance: {
            ...
            acceleration060: "3.4 seconds",
            acceleration0100: "7.8 seconds",
            quarterMile: "11.2 seconds",
            brakingDistance: "100 ft (60-0)",
            lateralG: "1.05 g",
        },
        transmission: { type: "M Steptronic 8-Speed Automatic", gears: 8, driveType: "M xDrive All-Wheel Drive" },
        dimensions: {
            length: "199.6 in",
            width: "76.3 in",
            height: "59.5 in",
            wheelbase: "118.2 in",
            curbWeight: "5,390 lbs",
            fuelCapacity: "15.6 gal",
            cargoVolume: "12.4 cu ft",
        },
        fuel: { fuelType: "Hybrid (Premium + Electric)", cityMPG: "15 mpg", highwayMPG: "22 mpg", combinedMPG: "17 mpg" },
        wheels: {
            frontTires: "275/35 ZR21",
            rearTires: "285/35 ZR21",
            frontBrakes: "Carbon Ceramic 16.1\" 6-piston",
            rearBrakes: "Carbon Ceramic 15.7\" single-piston",
        },
        features: ["M xDrive AWD (RWD Mode Available)", "Adaptive M Suspension Professional", "M Compound Brakes", "M Sport Exhaust", "M Drive Professional", "48V Mild Hybrid + Electric Boost"],
        safety: ["8 Airbags", "Active Driving Assistant Professional", "Frontal Collision Warning", "Lane Departure Warning", "Parking Assistant Plus", "Surround View"],
        interior: ["Merino Leather with M Stitching", "M Multifunction Seats", "BMW Curved Display (12.3\" + 14.9\")", "Bowers & Wilkins Diamond Surround Sound", "Ambient Lighting", "M Carbon Fiber Trim"],
        description: "The G90 BMW M5 is the most powerful M5 ever — a 717 hp twin-turbo V8 plug-in hybrid that combines savage straight-line speed with the practicality of a luxury sedan. It can run in pure EV mode for silent city driving, then unleash all 738 lb-ft of torque on demand.",
        sketchfabId: "f28407cda1044fd28d82855be8af3e75",
    },
};
...
export function getKnownMakesAndModels(): Record<string, string[]> {
    ...
    const displayNames: Record<string, { make: string; model: string }> = {
        ...
        "ferrari|roma": { make: "Ferrari", model: "Roma" },
